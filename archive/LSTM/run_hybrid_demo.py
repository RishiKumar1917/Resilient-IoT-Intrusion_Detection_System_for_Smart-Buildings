...
def main() -> None:
    ...
    parser.add_argument("--window-size", type=int, default=60, help="Sliding window length.")
    ...
    summary = run_demo_pipeline(
        data_config=DataConfig(window_size=args.window_size, data_path="enhanced_iot_dataset.csv"),
